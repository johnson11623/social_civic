...
const (
	...
	MsgInvalidReason    Key = "moderation.invalid_reason"
	MsgAlreadyReported  Key = "moderation.already_reported"
	MsgDetailsTooLong   Key = "moderation.details_too_long"
	MsgInvalidAction    Key = "moderation.invalid_action"
	MsgAlreadyModerated Key = "moderation.already_moderated"
	MsgNotesTooLong     Key = "moderation.notes_too_long"
	MsgActionNotFound   Key = "moderation.action_not_found"
	MsgNotAuthor        Key = "moderation.not_author"
	MsgOutsideWindow    Key = "moderation.outside_window"
	MsgNotAppealable    Key = "moderation.not_appealable"
	MsgAlreadyAppealed  Key = "moderation.already_appealed"
	MsgStatementInvalid Key = "moderation.statement_invalid"
